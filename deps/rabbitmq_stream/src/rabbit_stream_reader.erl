...
close(Transport,
    ...
    [begin
     ...
     || #consumer{segment = Log, properties = Properties} = Consumer
    ...
    {Connection1, ConnState1} =
        case Consumers0 of
            #{SubId := Consumer0} ->
                ...
                #consumer{segment = Log0} = Consumer0,
                Log1 =
                    case {Active, Log0} of
                        {false, undefined} ->
                            undefined;
                ...
                Consumer1 = Consumer0#consumer{active = Active, segment = Log1},
    ...
    case maps:take(CorrelationId, Requests0) of
        {{{subscription_id, SubscriptionId}, {side_effects, SideEffects}},
         Rs} ->
            ...
            Consumers1 =
                case Consumers of
                    #{SubscriptionId := #consumer{active = true} = Consumer} ->
                        ...
                        Segment =
                            init_reader(ConnTransport,
                                        ...
                                        Properties,
                                        OffsetSpec),
                        Consumer1 = Consumer#consumer{segment = Segment},
                        Consumer2 =
                        ...
                        #consumer{counters = ConsumerCounters,
                                  segment = Segment2} =
                            Consumer2,
                        ConsumerOffset = osiris_log:next_offset(Segment2),
                    ...
                    #{SubscriptionId := #consumer{active = false}} ->
...
maybe_dispatch_on_subscription(Transport,
    ...
    case send_chunks(Transport, ConsumerState, SendFileOct) of
        ...
        {{segment, Segment1}, {credit, Credit1}} ->
            ConsumerState1 =
                ConsumerState#consumer{segment = Segment1, credit = Credit1},
            Consumers1 = Consumers#{SubscriptionId => ConsumerState1},

            #consumer{counters = ConsumerCounters1} = ConsumerState1,
...
maybe_dispatch_on_subscription(_Transport,
    ...
    rabbit_log:debug("No initial dispatch for subscription ~p for now, "
                     ...
                     [SubscriptionId]),
    #consumer{credit = Credit, offset = Offset} = ConsumerState,
